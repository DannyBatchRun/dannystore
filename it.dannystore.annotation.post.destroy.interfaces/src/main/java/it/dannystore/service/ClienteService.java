...
public class ClienteService implements InitializingBean, DisposableBean {
	...
	public void afterPropertiesSet() throws Exception {
		System.out.println("Creazione di ClienteService.");
	}
	
	@Override
	public void destroy() throws Exception {
		System.out.println("Chiusura di ClienteService");
	}
