...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		ProdottoService dannyStoreProdotto = annotationConfigProdotto();
		ClienteService dannyStoreCliente = annotationConfigCliente();
	...
	public static ProdottoService annotationConfigProdotto() {
	...
	public static ClienteService annotationConfigCliente() {
		ApplicationContext context = new AnnotationConfigApplicationContext(DannyStoreConfig.class);
