...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("bean-init-destroy.xml");
		ProdottoService dannyStoreProdotto = xmlConfigProdottoWithInitDestroy(context);
		ClienteService dannyStoreCliente = xmlConfigClienteWithInitDestroy(context);
	...
	public static void initProgramming() {
		System.out.println("Inizializzazione del Sistema");
	}
	
	public static void closeProgramming() {
	...
	public static ProdottoService xmlConfigProdottoWithInitDestroy(ApplicationContext context) {
		ProdottoService dannyStoreProdotto = context.getBean("prodotto", ProdottoService.class);
		return dannyStoreProdotto;
	}
	
	public static ClienteService xmlConfigClienteWithInitDestroy(ApplicationContext context) {
