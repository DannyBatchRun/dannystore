...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		ProdottoService dannyStoreProdotto = xmlConfigFactoryProdotto();
		ClienteService dannyStoreCliente = xmlConfigFactoryCliente();
	...
	public static ProdottoService xmlConfigFactoryProdotto() {
	...
	public static ClienteService xmlConfigFactoryCliente() {
		ApplicationContext context = new ClassPathXmlApplicationContext("bean-factory.xml");
