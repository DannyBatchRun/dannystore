...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		DannyStore dannyStore = simpleConfigXml();
	...
	public static DannyStore simpleConfigXml() {
		@SuppressWarnings("resource")
		ApplicationContext context = new ClassPathXmlApplicationContext("bean.xml");
		DannyStore dannyStore = new DannyStore();
		dannyStore.setProdottoService(context.getBean("prodotto", ProdottoService.class));
		dannyStore.setClienteService(context.getBean("cliente", ClienteService.class));
		return dannyStore;
	}
