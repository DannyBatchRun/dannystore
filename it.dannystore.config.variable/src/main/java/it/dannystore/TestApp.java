...
import it.dannystore.service.ClienteService;
import it.dannystore.service.ProdottoService;
...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		ClienteService dannyStoreCliente = xmlConfigVariableCliente();
		ProdottoService dannyStoreProdotto = xmlConfigVariableProdotto();
		
		xmlConfigVariableGetWelcome();
	...
	public static void xmlConfigVariableGetWelcome() {
		ApplicationContext context = new ClassPathXmlApplicationContext("bean-variable.xml");
		WelcomeService benvenuto = context.getBean("welcome", WelcomeService.class);
		String welcomeMessage = benvenuto.getWelcomeMessage();
		System.out.println(welcomeMessage);
	}
	
	
	public static ClienteService xmlConfigVariableCliente() {
		ApplicationContext context = new ClassPathXmlApplicationContext("bean-variable.xml");
		ClienteService dannyStoreCliente = context.getBean("cliente", ClienteService.class);
		return dannyStoreCliente;
	}
	
	public static ProdottoService xmlConfigVariableProdotto() {
		ApplicationContext context = new ClassPathXmlApplicationContext("bean-variable.xml");
