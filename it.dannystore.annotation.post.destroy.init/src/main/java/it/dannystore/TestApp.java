...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new AnnotationConfigApplicationContext(DannyStoreConfig.class);
	...
	public static ProdottoService annotationConfigProdotto(ApplicationContext context) {
		ProdottoService dannyStoreProdotto = context.getBean("prodottoAnnotation", ProdottoService.class);
		return dannyStoreProdotto;
	}
	
	public static ClienteService annotationConfigCliente(ApplicationContext context) {
